...
function pyramid(n) {
  let totalSpaceAmount = 0;
  let blockAmount = 1;
  let textToPrint = "";
  // max amount of blocks that is on the last level is always 2*n - 1
  ...
  for (let i = 1; i <= n; i++) {
    ...
    totalSpaceAmount = maxAmount - blockAmount;

    // amount of spaces is always even
    // half of it should be at the beginning, and the other half should be at the end
    let spaceAmount = totalSpaceAmount / 2;
