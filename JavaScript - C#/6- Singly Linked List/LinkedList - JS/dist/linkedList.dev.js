...
function () {
  ...
  _createClass(SinglyLinkedList, [{
    ...
    value: function insert(index, val) {
      if (index < 0 || index > this.length) return null;else if (index === this.length) this.push(val);else if (index === 0) this.unshift(val);else {
...
console.log("Head: ".concat(linkedList.head.val, "\nTail: ").concat(linkedList.tail.val, "\nLength: ").concat(linkedList.length));